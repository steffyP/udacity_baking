...
public class IngredientsWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        CharSequence ingredients = IngredientsWidgetConfigureActivity.loadIngredients(context, appWidgetId);

        CharSequence title = IngredientsWidgetConfigureActivity.loadRecipe(context, appWidgetId);
